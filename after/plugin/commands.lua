...
vim.api.nvim_create_autocmd("ColorScheme", {
  pattern = "*",
  callback = function()
    vim.api.nvim_set_hl(0, "GitSignsDelete", { fg = "red", bg = 9 })
    vim.api.nvim_set_hl(0, "GitSignsChange", { fg = "lightgreen", bg = 9 })
    vim.api.nvim_set_hl(0, "GitSignsAdd", { fg = "cyan", bg = 9 })
    ...
    vim.api.nvim_set_hl(0, "CursorColumn", { bg = "gray10" })
    vim.api.nvim_set_hl(0, "CursorLine", { bg = "gray10" })
  end,
})
